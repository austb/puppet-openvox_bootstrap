...
try {
  ...
  if ($version -eq "latest") {
    # Normally this would query an index or manifest. For now, hardcode fallback.
    Write-Result "failure" "Cannot install version 'latest'. Request specific agent version."
  }
